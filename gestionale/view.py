...
class View:
    def __init__(self , page):
        self._page = page
        self._controller = None # non necessaria
    ...
    def carica_interfaccia(self):
        ...
        row1 = ft.Row(controls=[
            self._txtInNomeP , self._txtInPrezzo , self._txtInQuantita
        ...
        row2 = ft.Row(controls=[
            self._txtInNomeC, self._txtInMail , self._txtInCategoria
        ] , alignment=ft.MainAxisAlignment.CENTER)
        ...
        self._btnAdd = ft.ElevatedButton(text="Aggiungi ordine" ,
                                         ...
                                         width=200)
        self._btnGestisciOrdine = ft.ElevatedButton(text="Gestisci prox"
                                                         " ordine" ,
        ...
        row3 = ft.Row(controls=[
            self._btnAdd , self._btnGestisciOrdine , self._btnGestisciAllOrdini , self._btnStampaInfo
        ] , alignment=ft.MainAxisAlignment.CENTER)
